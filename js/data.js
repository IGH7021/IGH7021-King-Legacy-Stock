...
const APP_CHANGELOG = [
  { version: "V.4.5", date: "2026-09-11", time: "", changes: [
  ...
  { version: "V.4.4", date: "2026-09-11", time: "", changes: [
  ...
  { version: "V.4.3", date: "2026-09-10", time: "07:01", changes: [
    ...
    "ปรับการโหลดสคริปต์ให้ไม่บล็อกการแสดงผลหน้าเว็บ และจัดโครงสร้างการโหลดให้เป็นลำดับ"
  ] },
